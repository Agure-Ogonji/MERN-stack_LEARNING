...
const Chat = () => {
  ...
  return (
    <Box sx={{display: "flex", flex: 1, width: "100%", height: "100%", mt: 3, gap: 3}}>
      <Box sx={{display: {md: "flex", xs: "none", sm: "none"}, flex:0.3, flexDirection:"column"}}>
        <Box sx={{display: "flex", width: "100%", height: "60vh", bgcolor: "rgb(17,29,39)", borderRadius: 5, flexDirection:"column", mx: 3}}>
          ...
          <Typography sx={{mx: "auto", fontFamily: "work sans", my: 4, p: 3}}>
            YOU CAN ASK QUESTIONS RELATED TO BUSINESS, TECHNOLOGY, AND EDUCATION. HOWEVER, DO AVOID SHARING PERSONAL INFORMATION.
          </Typography>
      ...
      <Box sx={{display: "flex", flex: {md: 0.8, xs: 1, sm: 1}, flexDirection:"column", px:3}}>
        <Typography sx={{fontSize: "30px", color: "white", mb: 2, mx: "auto"}}>
          MODEL - GPT 3.5 TURBO
        </Typography>
